...
The test suite can be used for certification of providers not listed in the xref:../user/certified.adoc[Certification table], as detailed in xref:../operator/certification.adoc[Provider Certification].
